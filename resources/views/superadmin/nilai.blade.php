...
<div x-data="{ 
    ...
    <aside :class="{
        ...
        <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('superadmin.nilai') }}" class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-150 hover:bg-gray-100 {{ request()->routeIs('superadmin.nilai') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700' }}" :class="{ 'justify-center': sidebarMinimized }">
